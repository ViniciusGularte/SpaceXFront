...
export const LaunchesPastDocument = gql`
  ...
  launchesPast {
    ...
    `;
export type LaunchesPastProps<TChildProps = {}> = ApolloReactHoc.DataProps<LaunchesPastQuery, LaunchesPastQueryVariables> & TChildProps;
export function withLaunchesPast<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  LaunchesPastQuery,
  LaunchesPastQueryVariables,
  LaunchesPastProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, LaunchesPastQuery, LaunchesPastQueryVariables, LaunchesPastProps<TChildProps>>(LaunchesPastDocument, {
      alias: 'launchesPast',
      ...operationOptions
    });
};
